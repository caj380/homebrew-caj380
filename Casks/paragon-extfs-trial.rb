cask "paragon-extfs-trial" do
  ...
  zap trash: [
    ...
    "/Library/LaunchDaemons/com.paragon-software.extfs.loader.plist",
    "/Library/LaunchDaemons/com.paragon-software.extfsd.plist",
    "/Library/LaunchAgents/com.paragon-software.extfs.notification-agent.plist",
    "/Library/Filesystems/ufsd_ExtFS.fs/",
    "/Library/Extensions/ufsd_ExtFS.kext/",
    "/Library/PreferencePanes/ParagonExtFS.prefPane/",
  ]
end
